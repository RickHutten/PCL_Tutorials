...
int main(int argc, char **argv)
{
    ...
    // Initialise fast feature estimation
    ...
    // Create implicit shape model estimation
    ...
    //ism.trainISM(model);
    std::string file("../models/output/trained_ism_model.txt");
    //model->saveModelToFile(file);
    model->loadModelFromfile(file); // Don't need to load file in this case
    ...
    point.g = 0;
    point.b = 0;
    std::cout << strongest_peaks.size() << std::endl;
