...
int main(int argc, char **argv)
{
    ...
    if (pcl::io::loadPCDFile<pcl::PointXYZ>("../models/registration/room_scan1.pcd", *target_cloud) == -1)
    {
    ...
    if (pcl::io::loadPCDFile<pcl::PointXYZ>("../models/registration/room_scan2.pcd", *input_cloud) == -1)
    {
    ...
    pcl::io::savePCDFileASCII("../models/output/room_scan2_transformed.pcd", *output_cloud);
